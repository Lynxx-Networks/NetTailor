...
pub fn login() -> Html {
            ...
            <div class="relative p-4 w-full max-w-md max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="#">
                            <p class="text-m font-semibold text-gray-900 dark:text-white">
                            {"Welcome to NetTailor! This appears to be your first time logging in. To start, let's get some basic information about your time and time zone preferences. This will determine how times appear throughout the app."}
                            </p>
                            <div>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="#">
                            <p class="text-m font-semibold text-gray-900 dark:text-white">
                            {"Welcome to NetTailor! Please enter your MFA Code Below."}
                            </p>
    ...
    let background_color = "#001626";

    html! {
        <>
        <div id="login-page" style={format!("background-color: {}; background-repeat: no-repeat; background-attachment: fixed; background-size: cover;", background_color)}>
        {
            match *page_state {
            ...
            <div class="flex justify-center items-center h-screen">
                <div class="flex flex-col space-y-4 w-full max-w-xs p-8 border border-gray-300 rounded-lg shadow-lg bg-gray-600">
                    ...
                    <h1 class="text-xl font-bold mb-2 text-center">{"NetTailor"}</h1>
                    <p class="text-center">{"Precision-Crafted Configurations, One Config at a Time"}</p>
                    <input
                        type="text"
